      ...
      <section className="py-20 px-6 sm:px-8 lg:px-12">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl sm:text-5xl font-extrabold text-center mb-6 bg-gradient-to-r from-cyan-300 via-teal-300 to-emerald-300 bg-clip-text text-transparent drop-shadow-xl" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
              What is Blue Carbon?
            </h2>
            ...
            <div className="bg-gradient-to-br from-teal-500/5 to-ocean-500/5 backdrop-blur-sm border border-teal-500/20 rounded-2xl p-8 sm:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                ...
                >
                  <div className="text-5xl font-extrabold text-cyan-300 mb-2 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>5-10×</div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <div className="text-5xl font-extrabold text-cyan-300 mb-2 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>50%</div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.2 }}
                >
                  <div className="text-5xl font-extrabold text-cyan-300 mb-2 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>1000s</div>
      ...
      <section className="py-20 px-6 sm:px-8 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-white text-center mb-12 max-w-3xl mx-auto font-medium drop-shadow-md" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="h-full bg-gradient-to-br from-teal-500/10 to-transparent backdrop-blur-sm border border-teal-500/20 rounded-xl p-8 group-hover:border-teal-500/40 transition-colors">
                  ...
                  <h3 className="text-2xl font-extrabold text-white mb-4 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>Transparency</h3>
                  <p className="text-gray-100 leading-relaxed font-medium" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
              ...
              >
                <div className="h-full bg-gradient-to-br from-ocean-500/10 to-transparent backdrop-blur-sm border border-ocean-500/20 rounded-xl p-8 group-hover:border-ocean-500/40 transition-colors">
                  ...
                  <h3 className="text-2xl font-extrabold text-white mb-4 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>Traceability</h3>
                  <p className="text-gray-100 leading-relaxed font-medium" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
              ...
              >
                <div className="h-full bg-gradient-to-br from-blue-500/10 to-transparent backdrop-blur-sm border border-blue-500/20 rounded-xl p-8 group-hover:border-blue-500/40 transition-colors">
                  ...
                  <h3 className="text-2xl font-extrabold text-white mb-4 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>Verification</h3>
                  <p className="text-gray-100 leading-relaxed font-medium" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="h-full bg-gradient-to-br from-teal-500/5 to-ocean-500/5 backdrop-blur-sm border border-teal-500/20 rounded-2xl p-8 text-center group-hover:border-teal-500/40 group-hover:shadow-xl group-hover:shadow-teal-500/10 transition-all">
                    ...
                    <h3 className="text-2xl font-extrabold text-white mb-4 drop-shadow-lg" style={{ fontFamily: '"Vipnagorgialla", Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
                      {feature.title}
                    </h3>
